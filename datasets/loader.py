...
from utils import hwc_to_chw, read_img, crop_borders
...
class PairLoader(Dataset):
	...
	def __getitem__(self, idx):
		...
		if source_img.shape[0] % 8==0 and source_img.shape[1] % 8==0:
			pass
		else:
			source_img, target_img = crop_borders(source_img, target_img)
